              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number total-order-data"><strong style="color: #733686">{{ $total_sales }}</strong></div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="name"><strong style="color: #00c689">{{trans('file.Delivered')}}</strong></div>
                    <div class="count-number delivered-data"><strong style="color: #00c689">{{$livre_facture}}</strong></div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="name"><strong style="color: #ff8952">{{trans('file.In progress')}}</strong></div>
                    <div class="count-number in-progress-data"><strong style="color: #ff8952">{{$en_cours}}</strong></div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="name"><strong style="color: red">{{trans('file.Retourné')}}</strong></div>
                    <div class="count-number in-progress-data"><strong style="color: red">{{$returned}}</strong></div>
                  </div>
                </div>
              </div>
              <div class="row">
