        ...
        if(product[0] == 'combo') {
            ...
            $.get('products/product_warehouse/' + product[12], function(data) {
                ...
                if(data.product_variant_warehouse[0].length != 0) {
                    ...
                    var newBody = $("<tbody>");
                    var newRow = $("<tr>");
                    newRow.append('<th><?php echo e(trans("file.Variant")); ?></th><th><?php echo e(trans("file.Quantity")); ?></th>');
                    newHead.append(newRow);
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bota4906/noure.alwaleedoptics.com/resources/views/product/index.blade.php ENDPATH**/ ?>