        ...
        <table id="delivery-table" class="table">
            ...
            <tbody>
                ...
                <tr class="delivery-link" data-barcode="<?php echo e($barcode); ?>" data-delivery='[
                    ...
                    "<?php echo e(preg_replace("/[\n\r]/", "<br>", $lims_sale_data->customer_address)); ?>",
                    ...
                    <td><?php echo e(number_format($lims_sale_data->grand_total, 2, '.', '')); ?></td>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="to_redirect" value="deliveries">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bota4906/noure.alwaleedoptics.com/resources/views/delivery/index.blade.php ENDPATH**/ ?>