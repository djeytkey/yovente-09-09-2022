              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number total-order-data"><strong style="color: #733686"><?php echo e($total_sales); ?></strong></div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="name"><strong style="color: #00c689"><?php echo e(trans('file.Delivered')); ?></strong></div>
                    <div class="count-number delivered-data"><strong style="color: #00c689"><?php echo e($livre_facture); ?></strong></div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="name"><strong style="color: #ff8952"><?php echo e(trans('file.In progress')); ?></strong></div>
                    <div class="count-number in-progress-data"><strong style="color: #ff8952"><?php echo e($en_cours); ?></strong></div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="name"><strong style="color: red"><?php echo e(trans('file.Retourné')); ?></strong></div>
                    <div class="count-number in-progress-data"><strong style="color: red"><?php echo e($returned); ?></strong></div>
                  </div>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-sm-<?php echo e($profit_row); ?>">
                  <div class="wrapper count-title text-center">
                    <div class="icon"><i class="dripicons-trophy" style="color: #297ff9"></i></div>
                    <div class="name"><strong style="color: #297ff9"><?php echo e(trans('file.Payé')); ?></strong></div>
                ...
                <div class="col-sm-<?php echo e($profit_row); ?>">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="count-number profit-remain-data"><?php echo e(number_format((float)$reste, 2, '.', '')); ?></div>
                  </div>
                </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bota4906/noure.alwaleedoptics.com/resources/views/index.blade.php ENDPATH**/ ?>